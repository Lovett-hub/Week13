...
func main() {
	...
	db, err = sql.Open("mysql", "root:Password123@tcp(127.0.0.1:3306)/SAVIO_WEEK13")
	if err != nil {
...
func getCurrentTime(w http.ResponseWriter, r *http.Request) {
	...
	formattedTime := currentTime.Format("2006-01-02 14:12:01")

	_, err = db.Exec("INSERT INTO savio_log (timestamp) VALUES (?)", formattedTime)
	if err != nil {
